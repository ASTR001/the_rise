...
import 'SingleChat/SingleChatScreen.dart';
import 'SingleChat/CreateNewSingleChat.dart';

class MyChatList extends StatefulWidget {
  final bool groupChat;
  const MyChatList({Key key, this.groupChat}) : super(key: key);
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<MyChatList> with WidgetsBindingObserver {
  Stream chatRooms;
        ...
        return snapshot.hasData
            ? ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  userName = user
                      .where((i) => i.toString() != ConstCurrentUser.myUserName)
                      .toList();
                  }
